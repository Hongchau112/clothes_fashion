            ...
            <div class="nk-tb-item">
                ...
                <div class="nk-tb-col tb-col-lg">
                    <ul class="list-status">
                        <li><em class="icon text-success ni ni-check-circle"></em> <span>d/c mail</span></li>
                    </ul>
                </div>
                <div class="nk-tb-col tb-col-md">
                    ...
                    <ul class="nk-tb-actions gx-1">
                        <li>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="link-list-opt no-bdr">
                                        <li><a href="#"><em class="icon ni ni-focus"></em><span>View</span></a></li>
                                        ...
                                        <li><a href="#"><em class="icon ni ni-activity-round"></em><span>Block</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
